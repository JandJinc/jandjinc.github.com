...
<div class="pa-4">
    <img :src="require('@/assets/waaromai.jpg')" style="float: right; margin: 35px; height: 400px">
    <p style="@import url('https://fonts.googleapis.com/css2?family=EB+Garamond&display=swap'); font-family: 'EB Garamond', serif;font-size: 210%; white-space: pre-line;">
        {{`AI kan ons grootste wapen zijn, maar ook onze grootste vijand. Als je denkt aan een AI die gevaarlijk is komen zogenaamde killer robots al snel op, maar het kan veel simpeler dan dat: bijvoorbeeld door deepfakes. Je kan zo best wel makkelijk mensen dingen laten zeggen.
